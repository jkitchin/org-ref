...
You still use C-c ] to insert a default citation.

C-c ] C-u Ret will prompt you for a different citation type.

C-u C-c ] will insert a ref link.

C-u C-u C-c ] will insert a label link.
