...
An alternative to this exporter is to use an  `org-export-before-parsing-hook' to do the pre-processing like this.
...
[[elisp:(org-ref-export-to-md)]] TODO: doesn't seem to work

[[elisp:(org-ref-export-to-ascii)]]

[[elisp:(org-ref-export-to-odt)]]   TODO: doesn't seem to work, citations are not right.

[[elisp:(org-ref-export-to-message)]] export to body of an email message


*** Other formats without using CSL

An alternative approach to using citeproc is to use LaTeX/bibtex more directly. [[./org-ref-natbib-bbl-citeproc.el]] defines another pre-processor that uses LaTeX and natbib/bibtex to create citations and bibliographies.
