...
* References
You need to define the link style using <<>> tags. So, write the following in your document:

<<bibliographystyle link>> (you need to define the link style here)
bibliographystyle:unsrt (your bibliography style here. Some examples include unsrt, APA, etc).

<<bibliography link>>
bibliography:org-ref.bib (your bibliography file here)
